...
SOURCE_FILE="${SCRIPT_DIR}/aarch64_codegen_api_indirect_branch.cpp"
LL_FILE="${SCRIPT_DIR}/aarch64_codegen_api_indirect_branch.ll"
TEST_BIN="${CASE_BUILD_DIR}/aarch64_codegen_api_indirect_branch"
OBJECT_FILE="${CASE_BUILD_DIR}/aarch64_codegen_api_indirect_branch.o"
EXECUTABLE_FILE="${CASE_BUILD_DIR}/aarch64_codegen_api_indirect_branch.bin"
...
echo "verified: importer lowers indirectbr with blockaddress targets through native AArch64 br execution"
