...
TEST_BINARY="${TEST_BUILD_DIR}/optional_dialect_pack_switches"
TEST_SOURCE="${SCRIPT_DIR}/optional_dialect_pack_switches.cpp"
...
echo "verified: optional dialect pack switches reconfigure the default dialect set"
