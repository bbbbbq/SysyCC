...
TEST_BINARY="${TEST_BUILD_DIR}/default_dialect_registry"
TEST_SOURCE="${SCRIPT_DIR}/default_dialect_registry.cpp"
...
echo "verified: default dialect registration aggregates preprocess and stage registries"
