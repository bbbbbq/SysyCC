...
TEST_BINARY="${TEST_BUILD_DIR}/handler_registry_conflict_policy"
TEST_SOURCE="${SCRIPT_DIR}/handler_registry_conflict_policy.cpp"
...
echo "verified: handler registries preserve first owner and surface conflicts"
