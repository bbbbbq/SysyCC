...
TEST_BINARY="${TEST_BUILD_DIR}/semantic_feature_runtime_policy"
TEST_SOURCE="${SCRIPT_DIR}/semantic_feature_runtime_policy.cpp"
...
echo "verified: semantic feature registry gates extended builtin-type and qualifier-aware pointer rules"
