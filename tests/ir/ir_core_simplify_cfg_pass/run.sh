...
TEST_BINARY="${TEST_BUILD_DIR}/ir_core_simplify_cfg_pass"
TEST_SOURCE="${SCRIPT_DIR}/ir_core_simplify_cfg_pass.cpp"
INPUT_FILE="${SCRIPT_DIR}/ir_core_simplify_cfg_pass.sy"
