...
TEST_BINARY="${TEST_BUILD_DIR}/ir_core_copy_propagation_pass"
TEST_SOURCE="${SCRIPT_DIR}/ir_core_copy_propagation_pass.cpp"
INPUT_FILE="${SCRIPT_DIR}/ir_core_copy_propagation_pass.sy"
