...
TEST_BINARY="${TEST_BUILD_DIR}/ir_core_analysis_invalidation"
TEST_SOURCE="${SCRIPT_DIR}/ir_core_analysis_invalidation.cpp"
INPUT_FILE="${SCRIPT_DIR}/ir_core_analysis_invalidation.sy"
