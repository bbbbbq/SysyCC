...
TEST_BINARY="${TEST_BUILD_DIR}/ir_core_slp_vectorize"
TEST_SOURCE="${SCRIPT_DIR}/ir_core_slp_vectorize.cpp"
...
echo "verified: SLP vectorization packs straight-line scalar lanes"
