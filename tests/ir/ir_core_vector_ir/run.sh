...
TEST_BINARY="${TEST_BUILD_DIR}/ir_core_vector_ir"
TEST_SOURCE="${SCRIPT_DIR}/ir_core_vector_ir.cpp"
...
echo "verified: vector IR substrate lowers vector ops and vector reduction"
