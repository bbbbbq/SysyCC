...
TEST_BINARY="${TEST_BUILD_DIR}/ir_core_mem2reg_nested_continue_source"
TEST_SOURCE="${SCRIPT_DIR}/ir_core_mem2reg_nested_continue_source.cpp"
INPUT_FILE="${SCRIPT_DIR}/ir_core_mem2reg_nested_continue_source.sy"
