...
TEST_BINARY="${TEST_BUILD_DIR}/semantic_pointer_nullability_annotation"
TEST_SOURCE="${SCRIPT_DIR}/semantic_pointer_nullability_annotation.cpp"
...
echo "verified: semantic analysis preserves pointer nullability annotations as metadata"
