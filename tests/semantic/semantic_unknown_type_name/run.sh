...
TEST_BINARY="${TEST_BUILD_DIR}/semantic_unknown_type_name"
TEST_SOURCE="${SCRIPT_DIR}/semantic_unknown_type_name.cpp"
...
echo "verified: TypeResolver rejects unknown named types with one semantic error"
