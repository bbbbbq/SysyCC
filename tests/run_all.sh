...
should_require_nonempty_artifacts() {
    ...
    if [[ "${test_name}" == "line_directive_colon_filename" ]]; then
        return 1
    fi

    case "${test_name}" in
        macro_literal_expansion_bug|function_macro_argument_literal_bug|include_cycle_bug|invalid_macro_name_bug|define_invalid_parameter_name|define_duplicate_parameter_name|define_variadic_parameter_position|error_directive|error_directive_empty_payload|unmatched_else|unmatched_endif|duplicate_else|elif_after_else|include_missing_path|include_error_trace|include_next_missing|line_directive_invalid_number|defined_malformed|missing_endif|elifdef_missing_condition|line_directive_missing_number|line_directive_spaced_filename|line_directive_colon_filename|line_directive_trailing_tokens|include_empty_path|has_include_malformed|invalid_token_diagnostic|lexer_global_state_bug|lexer_parse_node_mode_guard|empty_token_stream_behavior|line_directive_logical_location|line_directive_spaced_logical_location|preprocess_dispatch_sentinel_bug|macro_redefinition_conflict|stringize_concatenation_combo|default_dialect_registry|lexer_keyword_conflict_policy|lexer_keyword_runtime_classification|parser_feature_runtime_policy|ast_feature_runtime_policy|semantic_feature_runtime_policy|preprocess_feature_runtime_policy|dialect_registration_fail_fast|restrict_qualified_pointer_runtime_policy|pointer_nullability_runtime_policy|strict_c99_dialect_configuration|optional_dialect_pack_switches|cli_dialect_option_mapping|complier_option_context_sync|handler_registry_conflict_policy|parser_error_diagnostic|ast_unknown_guard|semantic_source_file|semantic_logical_source_file|semantic_undefined_identifier|semantic_redefinition|semantic_call_arity|semantic_call_type|semantic_call_target|semantic_return_type|semantic_arrow_type|semantic_dot_type|semantic_assign_type|semantic_assign_lvalue|semantic_member_field|semantic_condition_type|semantic_conditional_condition|semantic_index_base|semantic_index_type|semantic_unary_address|semantic_unary_deref|semantic_prefix_operand|semantic_postfix_operand|semantic_binary_arithmetic|semantic_binary_bitwise|semantic_binary_logical|semantic_break_context|semantic_continue_context|semantic_case_context|semantic_default_context|semantic_case_constant|semantic_duplicate_case|semantic_multiple_default|semantic_missing_return|semantic_array_dimension_constant|semantic_const_initializer_constant|semantic_const_pointer_call_reject|semantic_equality_pointer|semantic_goto_undefined_label|semantic_incompatible_pointer_assignment_warning|semantic_relational_pointer|semantic_ternary_non_const_reject|semantic_unsupported_attribute|semantic_pointer_nullability_annotation|semantic_unused_variable_warning|semantic_unused_parameter_warning|semantic_unused_label_warning|semantic_statement_no_effect_warning|semantic_unreachable_code_warning|semantic_constant_condition_warning|semantic_bit_field_width_not_integer|semantic_bit_field_width_negative|semantic_bit_field_width_exceeds_base|semantic_unknown_type_name|semantic_type_resolver_unknown_type_warning|semantic_unused_but_set_variable_warning|semantic_unused_but_set_compound_warning|semantic_unused_but_set_self_update_warning|semantic_unused_static_function_warning|semantic_sign_compare_warning|semantic_sign_compare_equality_warning|semantic_narrowing_initializer_warning|semantic_narrowing_assignment_warning|semantic_narrowing_return_warning|semantic_narrowing_call_argument_warning|semantic_narrowing_safe_constant_no_warning|semantic_narrowing_explicit_cast_no_warning|ir_pointer_nullability_erasure|ir_unsupported_function_error|ir_build_core_ir_pass_missing_ast|ir_core_const_fold_pass|ir_core_dce_pass|ir_lower_pass_missing_core_ir|ir_core_canonicalize_pass|ir_top_level_pass_pipeline_llvm|ir_lower_function_declaration|ir_lower_function_pointer_call|ir_lower_struct_index|ir_lower_aarch64_placeholder|aarch64_native_reject_dump_ir|aarch64_native_reject_float_backend)
            return 1
            ;;
        *)
            return 0
