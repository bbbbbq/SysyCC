...
if [[ ${RC} -eq 0 ]]; then
    echo "error: line-directive lexer input unexpectedly succeeded" >&2
    exit 1
fi
...
echo "verified: lexer diagnostics inherit logical file and line mapping from preprocess output"
