...
INPUT_FILE="${SCRIPT_DIR}/ast_parenthesized_function_macro_name.sy"
...
grep -q 'FunctionDecl safe_add' "${AST_FILE}"
grep -q 'Static' "${AST_FILE}"

echo "verified: ast preserves macro-expanded parenthesized function names"
