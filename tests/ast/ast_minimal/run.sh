...
INPUT_FILE="${SCRIPT_DIR}/ast_minimal.sy"
AST_FILE="${BUILD_DIR}/intermediate_results/ast_minimal.ast.txt"
...
echo "verified: ast dump is generated for the minimal program"
