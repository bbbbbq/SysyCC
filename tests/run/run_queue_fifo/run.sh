...
INPUT_FILE="${SCRIPT_DIR}/run_queue_fifo.sy"
...
PROGRAM_INPUT="${SCRIPT_DIR}/run_queue_fifo.in"
EXPECTED_OUTPUT="${SCRIPT_DIR}/run_queue_fifo.out"
...
echo "verified: queue FIFO runtime test compiles, links, and matches expected output"
