...
INPUT_FILE="${SCRIPT_DIR}/run_sorted_list_insert.sy"
...
PROGRAM_INPUT="${SCRIPT_DIR}/run_sorted_list_insert.in"
EXPECTED_OUTPUT="${SCRIPT_DIR}/run_sorted_list_insert.out"
...
echo "verified: sorted-list insertion runtime test compiles, links, and matches expected output"
