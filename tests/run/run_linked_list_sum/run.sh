...
INPUT_FILE="${SCRIPT_DIR}/run_linked_list_sum.sy"
...
PROGRAM_INPUT="${SCRIPT_DIR}/run_linked_list_sum.in"
EXPECTED_OUTPUT="${SCRIPT_DIR}/run_linked_list_sum.out"
...
grep -q 'while\.cond' "${IR_FILE}"

echo "verified: linked-list traversal runtime test compiles, links, and matches expected output"
