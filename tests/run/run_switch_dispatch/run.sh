...
INPUT_FILE="${SCRIPT_DIR}/run_switch_dispatch.sy"
...
PROGRAM_INPUT="${SCRIPT_DIR}/run_switch_dispatch.in"
EXPECTED_OUTPUT="${SCRIPT_DIR}/run_switch_dispatch.out"
...
grep -q 'switch\.default' "${IR_FILE}"

echo "verified: switch runtime test compiles, links, and matches expected output"
