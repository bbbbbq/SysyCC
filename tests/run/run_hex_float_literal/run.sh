...
INPUT_FILE="${SCRIPT_DIR}/run_hex_float_literal.sy"
TEST_NAME="$(basename "${SCRIPT_DIR}")"
PROGRAM_INPUT="${SCRIPT_DIR}/run_hex_float_literal.in"
EXPECTED_OUTPUT="${SCRIPT_DIR}/run_hex_float_literal.out"
...
echo "verified: runtime accepts hexadecimal floating literals"
