...
INPUT_FILE="${SCRIPT_DIR}/run_floating_comparison_and_condition.sy"
...
PROGRAM_INPUT="${SCRIPT_DIR}/run_floating_comparison_and_condition.in"
EXPECTED_OUTPUT="${SCRIPT_DIR}/run_floating_comparison_and_condition.out"
