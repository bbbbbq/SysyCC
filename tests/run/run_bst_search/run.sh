...
INPUT_FILE="${SCRIPT_DIR}/run_bst_search.sy"
...
PROGRAM_INPUT="${SCRIPT_DIR}/run_bst_search.in"
EXPECTED_OUTPUT="${SCRIPT_DIR}/run_bst_search.out"
...
echo "verified: BST search runtime test compiles, links, and matches expected output"
