...
INPUT_FILE="${SCRIPT_DIR}/run_set_membership.sy"
...
PROGRAM_INPUT="${SCRIPT_DIR}/run_set_membership.in"
EXPECTED_OUTPUT="${SCRIPT_DIR}/run_set_membership.out"
...
echo "verified: set-membership runtime test compiles, links, and matches expected output"
