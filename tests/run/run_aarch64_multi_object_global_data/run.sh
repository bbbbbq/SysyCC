...
MAIN_SOURCE="${SCRIPT_DIR}/run_aarch64_multi_object_global_data_main.c"
HELPER_SOURCE="${SCRIPT_DIR}/run_aarch64_multi_object_global_data_helper.c"
...
assert_aarch64_relocations "${MAIN_OBJECT}" 'shared_counter|apply_delta'
...
echo "verified: AArch64 multi-object global-data smoke emits .o files, links, and runs"
