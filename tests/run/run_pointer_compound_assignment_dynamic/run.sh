...
INPUT_FILE="${SCRIPT_DIR}/run_pointer_compound_assignment_dynamic.sy"
...
PROGRAM_INPUT="${SCRIPT_DIR}/run_pointer_compound_assignment_dynamic.in"
EXPECTED_OUTPUT="${SCRIPT_DIR}/run_pointer_compound_assignment_dynamic.out"
...
grep -Eq '^  %t[0-9]+ = getelementptr inbounds i32, ptr %t[0-9]+, i32 %t[0-9]+$' "${IR_FILE}"

echo "verified: runtime executes dynamic pointer compound assignments"
