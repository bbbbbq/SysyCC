...
INPUT_FILE="${SCRIPT_DIR}/run_usual_arithmetic_promotions.sy"
...
PROGRAM_INPUT="${SCRIPT_DIR}/run_usual_arithmetic_promotions.in"
EXPECTED_OUTPUT="${SCRIPT_DIR}/run_usual_arithmetic_promotions.out"
