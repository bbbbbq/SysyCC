...
INPUT_FILE="${SCRIPT_DIR}/run_sequential_nested_loop_reset.sy"
...
EXPECTED_OUTPUT="${SCRIPT_DIR}/run_sequential_nested_loop_reset.out"
...
echo "verified: sequential nested loops preserve explicit reset stores across loop boundaries"
