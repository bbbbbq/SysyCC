...
INPUT_FILE="${SCRIPT_DIR}/run_ring_buffer_wrap.sy"
...
PROGRAM_INPUT="${SCRIPT_DIR}/run_ring_buffer_wrap.in"
EXPECTED_OUTPUT="${SCRIPT_DIR}/run_ring_buffer_wrap.out"
...
echo "verified: ring buffer wrap runtime test compiles, links, and matches expected output"
