...
INPUT_FILE="${SCRIPT_DIR}/run_priority_queue_pop.sy"
...
PROGRAM_INPUT="${SCRIPT_DIR}/run_priority_queue_pop.in"
EXPECTED_OUTPUT="${SCRIPT_DIR}/run_priority_queue_pop.out"
...
echo "verified: priority-queue ordering runtime test compiles, links, and matches expected output"
