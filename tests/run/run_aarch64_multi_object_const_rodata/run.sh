...
MAIN_SOURCE="${SCRIPT_DIR}/run_aarch64_multi_object_const_rodata_main.c"
HELPER_SOURCE="${SCRIPT_DIR}/run_aarch64_multi_object_const_rodata_helper.c"
...
assert_aarch64_relocations "${MAIN_OBJECT}" \
    'shared_message|shared_message_len|shared_message_ptr'
...
echo "verified: AArch64 multi-object const/rodata smoke emits .o files, links, and runs"
