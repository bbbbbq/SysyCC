...
INPUT_FILE="${SCRIPT_DIR}/run_deque_pop_ends.sy"
...
PROGRAM_INPUT="${SCRIPT_DIR}/run_deque_pop_ends.in"
EXPECTED_OUTPUT="${SCRIPT_DIR}/run_deque_pop_ends.out"
...
echo "verified: deque end-pop runtime test compiles, links, and matches expected output"
