...
INPUT_FILE="${SCRIPT_DIR}/run_echo_int.sy"
...
PROGRAM_INPUT="${SCRIPT_DIR}/run_echo_int.in"
EXPECTED_OUTPUT="${SCRIPT_DIR}/run_echo_int.out"
...
echo "verified: runtime echo test compiles, links, and matches expected output"
