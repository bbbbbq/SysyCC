...
INPUT_FILE="${SCRIPT_DIR}/run_usual_arithmetic_float_int.sy"
...
PROGRAM_INPUT="${SCRIPT_DIR}/run_usual_arithmetic_float_int.in"
EXPECTED_OUTPUT="${SCRIPT_DIR}/run_usual_arithmetic_float_int.out"
...
echo "verified: runtime float/int usual arithmetic conversion produces the expected value"
