...
int main() {
    ...
    auto *module =
        context->create_module<CoreIrModule>("aarch64_native_phi_if_else_join");
    auto *function =
        module->create_function<CoreIrFunction>("join", function_type, false);
    ...
    test::assert_contains(asm_text, ".Ljoin_left_to_merge_phi:");
    test::assert_contains(asm_text, ".Ljoin_right_to_merge_phi:");
    test::assert_contains(asm_text, "b .Ljoin_merge");
    return 0;
}
