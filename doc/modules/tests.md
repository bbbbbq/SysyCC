...
| compiler builtins | `tests/run/run_builtin_alloca_stack_smoke`, `tests/run/run_builtin_clz_smoke`, `tests/run/run_builtin_ctz_smoke`, `tests/run/run_builtin_prefetch_smoke` | Covers `__builtin_alloca` lowering to LLVM stack allocation plus GCC bit-scan and prefetch builtins used by real-project bitmap/hash-table code. |
