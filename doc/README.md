...
- The compiler core now also owns a shared `SourceManager`, and downstream lexer/parser scanner sessions consume one shared `SourceMappingView` instead of manually pairing a physical file with a preprocess line map.
