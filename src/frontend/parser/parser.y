...
%token <node> INVALID
%token <node> CONST VOLATILE EXTERN STATIC REGISTER ATTRIBUTE ASM EXTENSION INLINE NORETURN RESTRICT ATOMIC NULLABILITY LONG SIGNED SHORT UNSIGNED INT CHAR VOID FLOAT DOUBLE FLOAT16 IF ELSE WHILE FOR DO SWITCH CASE DEFAULT BREAK CONTINUE GOTO RETURN STRUCT UNION ENUM TYPEDEF SIZEOF TYPEOF ALIGNAS TYPE_NAME
...
function_declarator
    ...
    | LPAREN pointer function_declarator RPAREN LPAREN function_parameter_list_opt RPAREN
      { $$ = sysycc::make_nonterminal_node("function_declarator", {$1, $2, $3, $4, $5, $6, $7}); }
    | pointer LPAREN pointer function_declarator RPAREN LPAREN function_parameter_list_opt RPAREN
