...
bool dispatch_aarch64_lowered_instruction(DispatchContext &context,
    ...
    case CoreIrOpcode::CondJump:
        ...
        return context.emit_cond_jump(
            machine_block, static_cast<const CoreIrCondJumpInst &>(instruction), state,
            current_block);
    case CoreIrOpcode::Return:
        context.emit_debug_location(machine_block, instruction.get_source_span(), state);
        return context.emit_return(machine_function, machine_block,
    ...
    case CoreIrOpcode::AddressOfGlobal:
        ...
        return context.emit_address_of_global(
            machine_block, static_cast<const CoreIrAddressOfGlobalInst &>(instruction),
            state);
    ...
    case CoreIrOpcode::GetElementPtr:
        ...
        return context.emit_getelementptr(
            machine_block, static_cast<const CoreIrGetElementPtrInst &>(instruction),
            state);
    }
    return false;
}
